...
jQuery(document).ready(function($) {  
    ...
    /* Animation Stuff */
    $('#hill, #hill_foot').pan({fps: 11, speed: 3, dir: 'left', depth: 10});
    $('#light, #light_foot').pan({fps: 10, speed: 1.3, dir: 'left', depth: 10});
    $('#house, #house_foot').pan({fps: 3, speed: 1, dir: 'left', depth: 10});
    $('#cloud, #cloud_foot').pan({fps: 1, speed: 1, dir: 'right', depth: 10});
});
